...
class AddNewTeacherControllerImp extends AddNewTeacherController {
  ...
  @override
  void onInit() async {
    firstName = TextEditingController(text: teacher?.firstName ?? "Omar");
    lastName = TextEditingController(text: teacher?.lastName ?? "Bkdash");
    dateOfBirth =
        TextEditingController(text: teacher?.dateOfBirth ?? "1993-01-01");
